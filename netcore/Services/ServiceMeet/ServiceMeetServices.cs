...
namespace netcore.Services.ServiceMeet
{
    ...
    public class ServiceMeetServices : IServiceMeetServices
    {
        ...
        public ServiceMeetServices(ApplicationDbContext context, ILogger<ServiceMeetServices> logger)
        {
        ...
        public async Task<Result<int>> SaveAsync(ServiceMeetInputDto input, CancellationToken cancellationToken = default)
        {
            try
            {
                var serviceMeet = new netcore.Models.ServiceMeet
                {
