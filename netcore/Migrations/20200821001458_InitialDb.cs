        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DayOfAvaliability = table.Column<DateTime>(nullable: false),
                    ServiceCount = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AvaliableMaids", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CartItemId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CleaningPlaceId = table.Column<int>(nullable: false),
                    CleaningPlaceRoomId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "CleaningPlaceCleaningPlaceRooms",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CleaningPlaceCleaningPlaceRooms", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "CleaningPlaceRoomServiceTypes",
                columns: table => new
                {
                    CleaningPlaceRoomServiceTypeId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CleaningPlaceRoomId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CleaningPlaceRoomServiceTypes", x => x.CleaningPlaceRoomServiceTypeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ServiceMeetId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceMeeting", x => x.ServiceMeetId);
                    table.ForeignKey(
                        name: "FK_ServiceMeeting_CartItems_CartItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AdditionalServiceTypeId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdditionalServiceTypes", x => x.AdditionalServiceTypeId);
                    table.ForeignKey(
                        name: "FK_AdditionalServiceTypes_Users_CreatorUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CleaningPlaceRooms", x => x.CleaningPlaceRoomId);
                    table.ForeignKey(
                        name: "FK_CleaningPlaceRooms_Users_CreatorUserId",
                        column: x => x.CreatorUserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "ServiceContactsInfo",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AdditionalServiceInfo = table.Column<string>(nullable: true),
                    Address = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceContactsInfo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceContactsInfo_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceMeetId = table.Column<int>(nullable: true),
                    UserId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employees_ServiceMeeting_ServiceMeetId",
                        column: x => x.ServiceMeetId,
                        principalTable: "ServiceMeeting",
                        principalColumn: "ServiceMeetId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_AdditionalServiceTypes_AdditionalServiceTypeId",
                        column: x => x.AdditionalServiceTypeId,
                        principalTable: "AdditionalServiceTypes",
                        principalColumn: "AdditionalServiceTypeId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CleaningPlaceId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CleaningPlaceRoomId = table.Column<int>(nullable: true),
                    CreationDate = table.Column<DateTime>(nullable: false),
                    CreatorUserId = table.Column<int>(nullable: false),
                    DeleteDate = table.Column<DateTime>(nullable: true),
                    DeleteUserId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CleaningPlaces", x => x.CleaningPlaceId);
                    table.ForeignKey(
                        name: "FK_CleaningPlaces_CleaningPlaceRooms_CleaningPlaceRoomId",
                        column: x => x.CleaningPlaceRoomId,
                        principalTable: "CleaningPlaceRooms",
                        principalColumn: "CleaningPlaceRoomId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CleaningPlaces_Users_CreatorUserId",
                        column: x => x.CreatorUserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceTypes_CleaningPlaceRooms_CleaningPlaceRoomId",
                        column: x => x.CleaningPlaceRoomId,
                        principalTable: "CleaningPlaceRooms",
                        principalColumn: "CleaningPlaceRoomId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceTypes_Users_CreatorUserId",
                        column: x => x.CreatorUserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Minute = table.Column<int>(nullable: false),
                    Month = table.Column<int>(nullable: false),
                    ServiceContactInfoId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceOrders_CartItems_CartItemId",
                        column: x => x.CartItemId,
                        principalTable: "CartItems",
                        principalColumn: "CartItemId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceOrders_ServiceContactsInfo_ServiceContactInfoId",
                        column: x => x.ServiceContactInfoId,
                        principalTable: "ServiceContactsInfo",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EmployeeScheduleId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AvaliableDay = table.Column<DateTime>(nullable: false),
                    EmployeeId = table.Column<int>(nullable: false),
                    IsActive = table.Column<bool>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeesMeetingServices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmployeesMeetingServices_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "EmployeeId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeesMeetingServices_ServiceMeeting_ServiceMeetId",
                        column: x => x.ServiceMeetId,
                        principalTable: "ServiceMeeting",
                        principalColumn: "ServiceMeetId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "ServiceOrderAdditionalServices",
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AdditionalServiceId = table.Column<int>(nullable: false),
                    ServiceOrderId = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceOrderAdditionalServices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceOrderAdditionalServices_ServiceOrders_ServiceOrderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AvaliableMaidHours", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AvaliableMaidHours_EmployeeSchedules_EmployeeScheduleId",
                        column: x => x.EmployeeScheduleId,
                        principalTable: "EmployeeSchedules",
                        principalColumn: "EmployeeScheduleId",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_AdditionalServiceTypes_CreatorUserId",
                table: "AdditionalServiceTypes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvaliableMaidHours_EmployeeScheduleId",
                table: "AvaliableMaidHours",
                column: "EmployeeScheduleId");

            migrationBuilder.CreateIndex(
                name: "IX_CleaningPlaceRooms_CreatorUserId",
                table: "CleaningPlaceRooms",
                column: "CreatorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CleaningPlaces_CleaningPlaceRoomId",
                table: "CleaningPlaces",
                column: "CleaningPlaceRoomId");

            migrationBuilder.CreateIndex(
                name: "IX_CleaningPlaces_CreatorUserId",
                table: "CleaningPlaces",
                column: "CreatorUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_ServiceMeetId",
                table: "Employees",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeesMeetingServices_EmployeeId",
                table: "EmployeesMeetingServices",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeesMeetingServices_ServiceMeetId",
                table: "EmployeesMeetingServices",
                column: "ServiceMeetId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_AdditionalServiceTypeId",
                table: "OrderItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceContactsInfo_UserId",
                table: "ServiceContactsInfo",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceMeeting_CartItemId",
                table: "ServiceMeeting",
                column: "CartItemId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceOrderAdditionalServices_ServiceOrderId",
                table: "ServiceOrderAdditionalServices",
                column: "ServiceOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceOrders_CartItemId",
                table: "ServiceOrders",
                column: "CartItemId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceOrders_ServiceContactInfoId",
                table: "ServiceOrders",
                column: "ServiceContactInfoId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceTypes_CleaningPlaceRoomId",
                table: "ServiceTypes",
                column: "CleaningPlaceRoomId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceTypes_CreatorUserId",
                table: "ServiceTypes",
                column: "CreatorUserId");
