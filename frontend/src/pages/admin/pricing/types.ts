...
// Admin/CRUD shape for recurrence discounts (different from the public booking
// shape in shared/types/api.types.ts — keep both names distinct to avoid drift).
export interface AdminRecurrenceDiscount {
  id: number;
