  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'fixed z-50 grid gap-4 border bg-white shadow-xl duration-200',
        'inset-x-0 bottom-0 w-full max-w-full rounded-t-2xl rounded-b-none p-6 max-h-[92vh]',
        'data-[state=open]:animate-in data-[state=closed]:animate-out',
        'data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom',
        // Desktop (sm+): centered dialog with zoom, rounded on all sides
